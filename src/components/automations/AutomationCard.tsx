  ...
  return (
    ...
    >
      ...
      `}>
        ...
        {/* Ambient background glow - always visible, intensifies on hover */}
        <div className={`
          absolute inset-0 rounded-[24px] bg-gradient-to-r ${feature.accent} 
          opacity-20 group-hover:opacity-40 transition-opacity duration-700 pointer-events-none
          will-change-opacity
        `} />
          ...
          <div className="relative w-20 h-20 mx-auto lg:mx-0">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <feature.icon 
                ...
                `}
                style={{
                  filter: `drop-shadow(0 2px 8px rgba(255, 255, 255, 0.1)) ${isHovered ? `drop-shadow(0 4px 16px rgba(59, 130, 246, 0.3))` : ''}`,
                  transition: 'all 0.5s cubic-bezier(0.4, 0, 0.2, 1)'
                }}
              />
            </div>
            
            {/* Stable ambient ring - always visible */}
            <div className={`
              absolute inset-[-2px] rounded-2xl bg-gradient-to-r ${feature.accent} 
              opacity-15 group-hover:opacity-30 transition-opacity duration-500 blur-sm
              will-change-opacity
            `} />
          </div>
        </div>
      ...
      <div className={`
        ...
        opacity-20 group-hover:opacity-40 transition-opacity duration-700 -z-10 blur-2xl
        will-change-opacity
