...
import { Settings, Zap, Shield, Brain, Clock, Cog } from 'lucide-react';
...
const AutomationHero = () => {
  return (
    <section className="relative min-h-[90vh] lg:min-h-[100vh] flex items-center overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 md:bottom-20 md:right-20 w-48 h-48 md:w-96 md:h-96 bg-cyan-500/10 rounded-full blur-3xl" />
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-3/4 right-1/3 w-1.5 h-1.5 bg-cyan-400/40 rounded-full animate-pulse" style={{
          animationDelay: '2s',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 md:space-y-8 order-2 lg:order-1">
            ...
            <div className="pt-2 md:pt-4">
              <Button 
                size="lg"
                className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-cyan-700 hover:from-blue-700 hover:to-cyan-800 text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                onClick={() => {
              ...
              >
                Ontdek automatiseringsmogelijkheden
              </Button>
            </div>
            ...
            <div className="grid grid-cols-1 gap-3 md:gap-4 pt-6 md:pt-8">
              ...
              <div className="flex items-center space-x-3 md:space-x-4 group">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-400/30 backdrop-blur-sm flex items-center justify-center group-hover:scale-105 transition-all duration-300 flex-shrink-0">
                  <Zap className="w-5 h-5 md:w-6 md:h-6 text-blue-300" />
                </div>
                <div className="space-y-1 min-w-0">
                  <h3 className="text-base md:text-lg font-semibold text-white">Processen 160x sneller</h3>
                  <p className="text-xs md:text-sm text-premium-silver/70">Wat 8 uur duurde, doen wij in 3 minuten</p>
                </div>
              </div>

              {/* Bullet 2 */}
              <div className="flex items-center space-x-3 md:space-x-4 group">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-cyan-500/20 to-indigo-500/20 border border-cyan-400/30 backdrop-blur-sm flex items-center justify-center group-hover:scale-105 transition-all duration-300 flex-shrink-0">
                  <Clock className="w-5 h-5 md:w-6 md:h-6 text-cyan-300" />
                </div>
                <div className="space-y-1 min-w-0">
                  <h3 className="text-base md:text-lg font-semibold text-white">24/7 operationeel zonder pauzes</h3>
                  <p className="text-xs md:text-sm text-premium-silver/70">Weekenden, nachten — altijd actief</p>
                </div>
              </div>

              {/* Bullet 3 */}
              <div className="flex items-center space-x-3 md:space-x-4 group">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-indigo-500/20 to-blue-500/20 border border-indigo-400/30 backdrop-blur-sm flex items-center justify-center group-hover:scale-105 transition-all duration-300 flex-shrink-0">
                  <Cog className="w-5 h-5 md:w-6 md:h-6 text-indigo-300" />
                </div>
                <div className="space-y-1 min-w-0">
                  <h3 className="text-base md:text-lg font-semibold text-white">Nul fouten door precisie-algoritmes</h3>
                  <p className="text-xs md:text-sm text-premium-silver/70">Elke handeling exact zoals bedoeld</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative flex items-center justify-center order-1 lg:order-2 py-8 md:py-12 lg:py-0">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full animate-pulse" style={{
                background: 'radial-gradient(circle, rgba(59, 130, 246, 0.1) 0%, rgba(6, 182, 212, 0.05) 50%, transparent 70%)',
                animationDuration: '4s'
              }} />
              ...
              <div className="relative w-52 h-52 sm:w-60 sm:h-60 md:w-64 md:h-64 lg:w-80 lg:h-80 rounded-full flex items-center justify-center" style={{
                background: 'radial-gradient(circle, rgba(59, 130, 246, 0.2) 0%, rgba(6, 182, 212, 0.1) 40%, rgba(99, 102, 241, 0.05) 70%, transparent 100%)',
                ...
                <Settings className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-32 lg:h-32 text-blue-300 drop-shadow-2xl animate-pulse" style={{
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                {/* Orbiting automation nodes - responsive positioning */}
                {[0, 1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
            ...
            {/* Automation flow connections - responsive */}
            <div className="absolute inset-0 pointer-events-none">
              {/* AI automation flow lines - responsive sizing and positioning */}
              ...
              <div className="absolute top-3/4 right-1/4 w-18 md:w-24 h-0.5 bg-gradient-to-l from-cyan-400/40 to-transparent transform -rotate-45 animate-pulse" style={{
                animationDelay: '1s'
              }} />
