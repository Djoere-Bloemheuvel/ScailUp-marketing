...
const AutomationHero = () => {
  const benefits = [{
    ...
    glowColor: 'shadow-[0_0_30px_rgba(20,184,166,0.3)]', // Enhanced teal glow
    hoverGlow: 'hover:shadow-[0_0_50px_rgba(20,184,166,0.5),0_0_80px_rgba(20,184,166,0.3)]', // Stronger teal glow on hover
    radiantGlow: 'shadow-[0_0_60px_rgba(20,184,166,0.2),0_0_120px_rgba(20,184,166,0.1),0_0_200px_rgba(20,184,166,0.05)]', // Outward radiant glow
    hoverRadiantGlow: 'hover:shadow-[0_0_80px_rgba(20,184,166,0.4),0_0_160px_rgba(20,184,166,0.2),0_0_300px_rgba(20,184,166,0.1)]', // Stronger radiant glow on hover
      ...
      <div className="relative max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            background: `
              linear-gradient(135deg, 
                ...
                ${benefit.accentColor.replace('from-', 'rgba(').replace('to-', 'rgba(')
                  ...
                  .replace('teal-400', '20, 184, 166, 0.4').replace('emerald-500', '16, 185, 129, 0.4')} 50%, 
            ...
            background: `radial-gradient(ellipse 200% 150% at 50% 50%, ${benefit.nativeColor === 'blue' ? 'rgba(59, 130, 246, 0.15)' : benefit.nativeColor === 'violet' ? 'rgba(139, 92, 246, 0.15)' : 'rgba(20, 184, 166, 0.15)'} 0%, transparent 60%)`,
            filter: 'blur(40px)'
          }} />
            ...
            background: `radial-gradient(ellipse 300% 200% at 50% 50%, ${benefit.nativeColor === 'blue' ? 'rgba(59, 130, 246, 0.08)' : benefit.nativeColor === 'violet' ? 'rgba(139, 92, 246, 0.08)' : 'rgba(20, 184, 166, 0.08)'} 0%, transparent 70%)`,
            filter: 'blur(60px)'
          }} />
              ...
              <CardContent className="p-8 text-center relative z-10">
                ...
                filter: 'brightness(1.1)'
                  ...
                  background: benefit.nativeColor === 'blue' ? '#38bdf8' : benefit.nativeColor === 'violet' ? '#8b5cf6' : '#14b8a6',
                  transform: 'translate(-50%, -50%)',
                  animationDuration: '3s'
                }}>
                      <div className="absolute w-2 h-2 rounded-full -top-8" style={{
                    background: benefit.nativeColor === 'blue' ? '#60a5fa' : benefit.nativeColor === 'violet' ? '#a78bfa' : '#2dd4bf'
                  }} />
                    </div>
                  </div>
                </div>
              ...
              background: `linear-gradient(to right, transparent, ${benefit.nativeColor === 'blue' ? 'rgba(59, 130, 246, 0.6)' : benefit.nativeColor === 'violet' ? 'rgba(139, 92, 246, 0.6)' : 'rgba(20, 184, 166, 0.6)'}, transparent)`,
              animationDelay: '0.2s'
            }} />
              </CardContent>
