...
const SpeedToLeadHero = () => {
  ...
  const stats = [
    { value: "391%", label: "meer conversie", description: "bewezen resultaat" },
    { value: "< 2 min", label: "reactietijd", description: "terwijl leads warm zijn" },
    { value: "1-3 mnd", label: "tot ROI", description: "snelle terugverdientijd" },
    { value: "24/7", label: "actief", description: "nooit een lead missen" }
  ];
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-0 overflow-hidden">
      ...
      {/* Speed to Lead themed backlights - purple/pink focus */}
      <div className="absolute inset-0 overflow-hidden opacity-50 sm:opacity-60">
        <div className="absolute top-1/4 left-1/2 w-[300px] h-[150px] sm:w-[400px] sm:h-[200px] md:w-[600px] md:h-[300px] lg:w-[800px] lg:h-[400px] bg-gradient-to-r from-purple-500 to-pink-600 rounded-full blur-2xl sm:blur-3xl transform -translate-x-1/2 -translate-y-1/4"></div>
        ...
        <div className="absolute top-1/2 left-1/4 w-[200px] h-[120px] sm:w-[300px] sm:h-[180px] md:w-[400px] md:h-[240px] lg:w-[500px] lg:h-[300px] bg-gradient-to-r from-purple-500 to-pink-600 rounded-full blur-2xl sm:blur-3xl opacity-80"></div>
      </div>
      ...
      <div className="absolute inset-0 opacity-20 sm:opacity-25 md:opacity-30">
        ...
        <div 
          className="absolute top-1/4 left-0 w-full h-16 sm:h-24 md:h-32 bg-gradient-to-r from-transparent via-purple-500/15 to-pink-600/20 rounded-full blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '0s', 
        ...
        />
        <div 
          className="absolute bottom-1/3 right-0 w-3/4 h-12 sm:h-18 md:h-24 bg-gradient-to-l from-transparent via-pink-600/25 to-purple-500/15 rounded-full blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '3s', 
        ...
        <div 
          className="absolute top-1/2 left-1/4 w-40 h-24 sm:w-60 sm:h-36 md:w-80 md:h-48 bg-gradient-to-br from-purple-500/10 to-pink-600/15 rounded-lg sm:rounded-xl md:rounded-2xl blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '1s', 
        ...
        />
        <div 
          className="absolute bottom-1/4 right-1/3 w-48 h-16 sm:w-72 sm:h-24 md:w-96 md:h-32 bg-gradient-to-tl from-pink-600/20 to-purple-500/10 rounded-lg sm:rounded-xl blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '5s', 
        ...
        <div 
          className="absolute top-1/3 right-1/4 w-12 h-8 sm:w-18 sm:h-12 md:w-24 md:h-16 bg-gradient-to-r from-purple-500/25 to-pink-600/30 rounded-md sm:rounded-lg blur-xl sm:blur-2xl" 
          style={{ 
            animationDelay: '2s', 
        ...
        />
        <div 
          className="absolute bottom-1/2 left-1/3 w-16 h-10 sm:w-24 sm:h-15 md:w-32 md:h-20 bg-gradient-to-l from-pink-600/25 to-purple-500/20 rounded-md sm:rounded-lg blur-xl sm:blur-2xl" 
          style={{ 
            animationDelay: '6s', 
...
export default SpeedToLeadHero;