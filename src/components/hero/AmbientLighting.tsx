    ...
    <>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(34, 211, 238, 0.3) 0%, rgba(34, 211, 238, 0.15) 30%, rgba(14, 165, 233, 0.08) 50%, transparent 70%)',
            filter: 'blur(80px)',
          }}
        />
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(139, 92, 246, 0.25) 0%, rgba(147, 51, 234, 0.12) 35%, rgba(109, 40, 217, 0.06) 55%, transparent 75%)',
            filter: 'blur(90px)',
          }}
        />
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(20, 184, 166, 0.2) 0%, rgba(13, 148, 136, 0.1) 40%, rgba(15, 118, 110, 0.05) 60%, transparent 80%)',
            filter: 'blur(70px)',
          }}
        />
        ...
        <div 
          className="absolute inset-0 opacity-[0.04] ambient-grain"
          style={{
            backgroundImage: `
              radial-gradient(circle at 20% 80%, rgba(255, 255, 255, 0.2) 0%, transparent 2%),
              radial-gradient(circle at 80% 20%, rgba(255, 255, 255, 0.15) 0%, transparent 2%),
              radial-gradient(circle at 40% 40%, rgba(255, 255, 255, 0.12) 0%, transparent 1.5%),
              radial-gradient(circle at 60% 90%, rgba(255, 255, 255, 0.1) 0%, transparent 1.5%),
              radial-gradient(circle at 90% 60%, rgba(255, 255, 255, 0.08) 0%, transparent 1%),
              radial-gradient(circle at 10% 30%, rgba(255, 255, 255, 0.06) 0%, transparent 1%)
            `,
        ...
        <div 
          className="absolute inset-0 opacity-[0.06] ambient-starfield"
          style={{
            backgroundImage: `
      ...
      <style dangerouslySetInnerHTML={{
        __html: `
          ...
          /* Mobile optimizations - Keep effects visible but lighter */
