        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 md:space-y-8 order-2 lg:order-1">
            ...
            <div className="pt-2 md:pt-4">
              <Button 
                size="lg"
                className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                onClick={() => {
            ...
            <div className="grid grid-cols-1 gap-3 md:gap-4 pt-6 md:pt-8">
              ...
              <div className="flex items-center space-x-3 md:space-x-4 group">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-blue-500/20 to-sky-500/20 border border-blue-400/30 backdrop-blur-sm flex items-center justify-center group-hover:scale-105 transition-all duration-300 flex-shrink-0">
                  <Brain className="w-5 h-5 md:w-6 md:h-6 text-blue-300" />
                </div>
                <div className="space-y-1 min-w-0">
                  <h3 className="text-base md:text-lg font-semibold text-white">Strategische AI-roadmaps die aansluiten bij jouw doelen</h3>
                  <p className="text-xs md:text-sm text-premium-silver/70">Van visie tot concrete implementatiestappen</p>
                </div>
              </div>

              {/* Bullet 2 */}
              <div className="flex items-center space-x-3 md:space-x-4 group">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-sky-500/20 to-cyan-500/20 border border-sky-400/30 backdrop-blur-sm flex items-center justify-center group-hover:scale-105 transition-all duration-300 flex-shrink-0">
                  <Target className="w-5 h-5 md:w-6 md:h-6 text-sky-300" />
                </div>
                <div className="space-y-1 min-w-0">
                  <h3 className="text-base md:text-lg font-semibold text-white">Proces-analyse en kansen voor automatisering</h3>
                  <p className="text-xs md:text-sm text-premium-silver/70">Maximale impact met minimale verstoring</p>
                </div>
              </div>

              {/* Bullet 3 */}
              <div className="flex items-center space-x-3 md:space-x-4 group">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-400/30 backdrop-blur-sm flex items-center justify-center group-hover:scale-105 transition-all duration-300 flex-shrink-0">
                  <Lightbulb className="w-5 h-5 md:w-6 md:h-6 text-cyan-300" />
                </div>
                <div className="space-y-1 min-w-0">
                  <h3 className="text-base md:text-lg font-semibold text-white">Begeleiding van concept tot succesvolle uitrol</h3>
                  <p className="text-xs md:text-sm text-premium-silver/70">Complete ondersteuning tijdens implementatie</p>
                </div>
              </div>
            </div>
          </div>
