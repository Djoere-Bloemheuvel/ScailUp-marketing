...
const AgentHero = () => {
  const benefits = [{
    ...
    hoverGlow: 'hover:shadow-[0_0_50px_rgba(20,184,166,0.5),0_0_80px_rgba(20,184,166,0.3)]',
    radiantGlow: 'shadow-[0_0_60px_rgba(20,184,166,0.2),0_0_120px_rgba(20,184,166,0.1),0_0_200px_rgba(20,184,166,0.05)]',
    hoverRadiantGlow: 'hover:shadow-[0_0_80px_rgba(20,184,166,0.4),0_0_160px_rgba(20,184,166,0.2),0_0_300px_rgba(20,184,166,0.1)]',
    iconColor: 'text-teal-400',
    nativeColor: 'teal',
    borderColor: 'border-teal-500/20',
    hoverBorderColor: 'group-hover:border-teal-400/40',
    backgroundTint: 'rgba(20, 184, 166, 0.03)',
    hoverBackgroundTint: 'rgba(20, 184, 166, 0.08)'
  }, {
    icon: Zap,
    ...
    hoverGlow: 'hover:shadow-[0_0_50px_rgba(34,211,238,0.5),0_0_80px_rgba(34,211,238,0.3)]',
    radiantGlow: 'shadow-[0_0_60px_rgba(34,211,238,0.2),0_0_120px_rgba(34,211,238,0.1),0_0_200px_rgba(34,211,238,0.05)]',
    hoverRadiantGlow: 'hover:shadow-[0_0_80px_rgba(34,211,238,0.4),0_0_160px_rgba(34,211,238,0.2),0_0_300px_rgba(34,211,238,0.1)]',
    iconColor: 'text-cyan-400',
    nativeColor: 'cyan',
    borderColor: 'border-cyan-500/20',
    hoverBorderColor: 'group-hover:border-cyan-400/40',
    backgroundTint: 'rgba(34, 211, 238, 0.03)',
    hoverBackgroundTint: 'rgba(34, 211, 238, 0.08)'
  }];
          ...
          {benefits.map((benefit, index) => (
            ...
            >
                ...
                background: `
                  linear-gradient(135deg, 
                    ...
                    ${benefit.accentColor.replace('from-', 'rgba(').replace('to-', 'rgba(')
                      .replace('teal-400', '20, 184, 166, 0.4').replace('emerald-600', '5, 150, 105, 0.4')
                      .replace('emerald-400', '52, 211, 153, 0.4').replace('green-600', '22, 163, 74, 0.4')
                      .replace('cyan-400', '34, 211, 238, 0.4').replace('blue-600', '37, 99, 235, 0.4')} 50%, 
              ...
              <div className={`absolute inset-0 rounded-2xl border opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out`} style={{
                borderColor: benefit.nativeColor === 'teal' ? 'rgba(20, 184, 166, 0.4)' : 
                           benefit.nativeColor === 'emerald' ? 'rgba(16, 185, 129, 0.4)' : 
                           'rgba(34, 211, 238, 0.4)'
              }} />
              ...
              <div className="absolute -inset-8 rounded-3xl opacity-0 group-hover:opacity-30 transition-all duration-1000 ease-out -z-20" style={{
                background: `radial-gradient(ellipse 200% 150% at 50% 50%, ${benefit.nativeColor === 'teal' ? 'rgba(20, 184, 166, 0.15)' : benefit.nativeColor === 'emerald' ? 'rgba(16, 185, 129, 0.15)' : 'rgba(34, 211, 238, 0.15)'} 0%, transparent 60%)`,
                filter: 'blur(40px)'
              }} />
              ...
              <div className="absolute -inset-16 rounded-full opacity-0 group-hover:opacity-20 transition-all duration-1500 ease-out -z-30" style={{
                background: `radial-gradient(ellipse 300% 200% at 50% 50%, ${benefit.nativeColor === 'teal' ? 'rgba(20, 184, 166, 0.08)' : benefit.nativeColor === 'emerald' ? 'rgba(16, 185, 129, 0.08)' : 'rgba(34, 211, 238, 0.08)'} 0%, transparent 70%)`,
                filter: 'blur(60px)'
              }} />
              ...
              <CardContent className="p-8 text-center relative z-10">
                ...
                <div className="relative w-20 h-20 mx-auto mb-6 transform transition-all duration-500 ease-out group-hover:scale-110 group-hover:rotate-3">
                  <div className="absolute inset-0 rounded-2xl p-0.5 transition-all duration-500 shadow-xl group-hover:shadow-2xl" style={{
                    ...
                    <div className="w-full h-full rounded-2xl flex items-center justify-center relative overflow-hidden transition-all duration-500" style={{
                      ...
                      border: `1px solid ${benefit.nativeColor === 'teal' ? 'rgba(20, 184, 166, 0.2)' : 
                              benefit.nativeColor === 'emerald' ? 'rgba(16, 185, 129, 0.2)' : 
                              'rgba(34, 211, 238, 0.2)'}`
                    }}>
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-60 transition-all duration-500">
                    <div className="absolute top-1/2 left-1/2 w-1 h-1 rounded-full animate-spin" style={{
                      background: benefit.nativeColor === 'teal' ? '#14b8a6' : benefit.nativeColor === 'emerald' ? '#10b981' : '#22d3ee',
                      transform: 'translate(-50%, -50%)',
                      animationDuration: '3s'
                    }}>
                      <div className="absolute w-2 h-2 rounded-full -top-8" style={{
                        background: benefit.nativeColor === 'teal' ? '#2dd4bf' : benefit.nativeColor === 'emerald' ? '#34d399' : '#67e8f9'
                      }} />
                    </div>
                  </div>
                </div>
                ...
                <h3 className="text-xl font-bold mb-4 group-hover:scale-105 transition-all duration-500 transform" style={{
                  color: benefit.nativeColor === 'teal' ? '#ccfbf1' : 
                         benefit.nativeColor === 'emerald' ? '#d1fae5' : 
                         '#cffafe',
                ...
                <div className="absolute top-0 left-0 w-full h-0.5 opacity-0 group-hover:opacity-80 transition-all duration-1000 ease-out transform -translate-y-full group-hover:translate-y-full" style={{
                  background: `linear-gradient(to right, transparent, ${benefit.nativeColor === 'teal' ? 'rgba(20, 184, 166, 0.6)' : benefit.nativeColor === 'emerald' ? 'rgba(16, 185, 129, 0.6)' : 'rgba(34, 211, 238, 0.6)'}, transparent)`,
                  animationDelay: '0.2s'
                }} />
              </CardContent>
