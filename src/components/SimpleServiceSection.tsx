...
const SimpleServiceSection = ({ service, index }: SimpleServiceSectionProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        {/* Content - using simple Tailwind animations like Hero */}
        <div className={`space-y-8 opacity-0 animate-services-entrance-1 ${isEven ? 'lg:order-2' : 'lg:order-1'}`}>
          {/* Typography */}
        ...
        {/* Visual Element - using simple Tailwind animations like Hero */}
        <div className={`relative opacity-0 animate-services-entrance-2 ${isEven ? 'lg:order-1 lg:justify-self-start' : 'lg:order-2 lg:justify-self-end'}`}>
