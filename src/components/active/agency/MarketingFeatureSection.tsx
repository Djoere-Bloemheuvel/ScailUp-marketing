...
const MarketingFeatureSection = () => {
  return (
    <section className="relative w-full bg-black py-16 lg:py-20">
      
      {/* Extended Ambient Background from above section */}
      <div className="absolute inset-0 overflow-visible z-0">
        {/* Receiving glows from above section */}
        <div className="absolute -top-32 right-1/6 w-[40rem] h-[50rem] bg-gradient-radial from-pink-500/60 via-pink-400/20 to-transparent blur-3xl opacity-50" />
        <div className="absolute -top-24 left-1/4 w-[30rem] h-[40rem] bg-gradient-radial from-purple-400/40 via-purple-300/15 to-transparent blur-3xl opacity-40" />
        
        {/* Original pink glows positioned behind text (right side) - reduced opacity for blending */}
        <div className="absolute top-1/3 right-1/6 w-[30rem] h-[25rem] bg-gradient-radial from-pink-500/60 via-pink-500/25 to-transparent blur-2xl opacity-30" />
        <div className="absolute bottom-1/4 right-1/8 w-[25rem] h-[20rem] bg-gradient-radial from-pink-400/55 via-pink-400/20 to-transparent blur-2xl opacity-30" />
        <div className="absolute top-1/2 right-1/4 w-[35rem] h-[30rem] bg-gradient-radial from-pink-600/50 via-pink-600/18 to-transparent blur-2xl opacity-30" style={{ transform: 'translateY(-50%)' }} />
        
        {/* Additional blending elements */}
        <div className="absolute top-1/6 left-1/5 w-[25rem] h-[20rem] bg-gradient-radial from-purple-500/30 via-purple-400/10 to-transparent blur-3xl opacity-40" />
      </div>
      ...
      {/* Natural Fade to Black Effects - only bottom */}
      <div 
