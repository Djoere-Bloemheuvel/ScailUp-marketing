  ...
  const marketingEngineServices = [
    {
      ...
      content: "Van blog posts tot social media content. 10x sneller content productie met AI-gedreven workflows die jouw brand voice perfect begrijpen."
    },
    {
      title: "SMART PUBLISHING AUTOMATION",
      content: "Automatische distributie over alle kanalen. Content wordt geoptimaliseerd per platform en ingepland op de beste tijden voor maximale reach."
    },
    {
      title: "PERFORMANCE TRACKING",
      content: "Real-time analytics die laten zien welke content converteert. Inzichten die je volgende content nog beter maken."
    },
    {
      title: "BRAND VOICE CONSISTENCY",
      content: "AI die jouw unieke tone-of-voice leert en toepast. Elke piece of content voelt authentiek aan en versterkt je merkidentiteit."
    }
  ];
          ...
          <div className="relative">
            ...
            <div className="relative mb-8">
              <div className="relative overflow-hidden rounded-xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-tr from-pink-500/8 via-transparent to-purple-500/4 opacity-60" />
                
                {/* Premium border glow */}
                <div className="absolute inset-0 rounded-xl border border-pink-400/15 shadow-lg shadow-pink-500/8" />
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="mt-8">
              <div className="relative group inline-block">
                <div className="absolute inset-0 rounded-full blur-xl opacity-20 group-hover:opacity-30 transition-all duration-500 scale-110 bg-gradient-to-r from-pink-400 via-pink-500 to-rose-500"></div>
                ...
                <button
                  ...
                  style={{ 
                    ...
                    boxShadow: `
                      ...
                      0 3px 10px rgba(236, 72, 153, 0.09),
                      inset 0 1px 0 rgba(255, 255, 255, 0.08)
                    `,
                    letterSpacing: '-0.01em'
                  }}
                >
                  <span className="relative z-10 mr-2">Q1 2026 verwacht</span>
