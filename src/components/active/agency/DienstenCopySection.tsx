...
const DienstenCopySection = () => {
  return (
    <>
      {/* First Image Block with Copy Overlay */}
      <section className="relative w-full overflow-hidden">
        <div className="relative w-full" style={{ height: '77vh' }}>
          ...
          <div className="absolute inset-0" style={{ backgroundColor: '#1a1a1a' }}>
            <img 
              src="/lead-engine-hero-v2.webp"
              alt="Lead Engine Hero"
      ...
      {/* Second Image Block with Copy Overlay */}
      <section className="relative w-full overflow-hidden">
        <div className="relative w-full" style={{ height: '77vh' }}>
          ...
          <div className="absolute inset-0" style={{ backgroundColor: '#1a1a1a' }}>
            <img 
              src="/marketing-engine-hero-v3.png"
...
export default DienstenCopySection;