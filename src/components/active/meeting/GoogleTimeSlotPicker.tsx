...
interface GoogleTimeSlotPickerProps {
  calendarId?: string;
}
...
const GoogleTimeSlotPicker: React.FC<GoogleTimeSlotPickerProps> = ({ 
  ...
  // Check for auth success and token on component mount
  useEffect(() => {
  ...
  const initiateGoogleAuth = () => {
    ...
    const authUrl = `/api/auth/google/oauth?calendar_id=${encodeURIComponent(calendarId)}`;
  ...
  const fetchAvailability = async (date: string) => {
    try {
      ...
      const response = await fetch(`/api/meetings/availability?date=${date}&access_token=${accessToken}`);
  ...
  const handleContactSubmit = async (e: React.FormEvent) => {
    ...
    if (!selectedSlot || !selectedDate || !accessToken) {
      setError('Selecteer eerst een datum en tijd, en zorg dat je bent ingelogd');
      return;
    }
      ...
      <div className="bg-black/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-8">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-light text-white mb-4">
            Plan een gesprek met Djoere
          </h2>
          <p className="text-gray-400 text-lg">
            Direct gekoppeld aan Google Calendar voor real-time beschikbaarheid
          </p>
        </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-400 mb-6">
                  Om real-time beschikbaarheid te tonen en afspraken in te plannen, 
                  hebben we toegang nodig tot Google Calendar.
                </p>
                
                <div className="bg-blue-900/20 border border-blue-700/30 rounded-lg p-4 mb-6">
                  <div className="text-blue-300 text-sm font-medium mb-2">Wat gebeurt er:</div>
                  <ul className="text-blue-200 text-sm space-y-1 text-left">
                    <li>• Je wordt doorgestuurd naar Google voor veilige authenticatie</li>
                    <li>• We krijgen alleen toegang tot jouw calendar data</li>
                    <li>• Je kunt de toegang altijd weer intrekken</li>
                  </ul>
                </div>
              </div>
          ...
          {currentStep === 'date' && (
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <span className="text-green-400 text-sm">✓ Verbonden met Google Calendar</span>
              </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Je ontvangt een bevestigingsmail met alle details en Google Meet link.
                </p>
              </div>
...
export default GoogleTimeSlotPicker;