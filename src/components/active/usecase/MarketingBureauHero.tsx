...
import MarketingBureauAnimatedHeadline from './MarketingBureauAnimatedHeadline';
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto z-30 text-center sm:text-left content-container"
        ...
        >
          ...
          >
            <MarketingBureauAnimatedHeadline />
          </motion.div>
...
export default MarketingBureauHero;