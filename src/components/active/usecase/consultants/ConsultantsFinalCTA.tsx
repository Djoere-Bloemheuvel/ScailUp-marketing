    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="text-center mb-16">
          ...
          >
            Geen lange formulieren. Geen verkooppraatje. Gewoon een eerlijk gesprek over wat er mogelijk is voor jouw consultancy.
          </p>
...
export default ConsultantsFinalCTA;