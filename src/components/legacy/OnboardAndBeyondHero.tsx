...
const OnboardAndBeyondHero = () => {
  ...
  const stats = [
    { value: "Vanaf dag één succesvol", label: "", description: "Nieuwe klanten voelen zich direct welkom en ondersteund door persoonlijke onboarding." },
    { value: "Proactieve ondersteuning", label: "", description: "Voorkom problemen voordat ze ontstaan met slimme monitoring en automatische interventies." },
    { value: "Lifetime value verhogen", label: "", description: "Tevreden klanten blijven langer, kopen meer en worden ambassadeurs van je merk." },
    { value: "Volledig geautomatiseerd", label: "", description: "Van welkomstsequenties tot success tracking - alles draait zonder handmatige interventie." }
  ];
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-0 overflow-hidden">
      ...
      {/* Onboard and Beyond themed backlights - blue/purple focus */}
      <div className="absolute inset-0 overflow-hidden opacity-50 sm:opacity-60">
        <div className="absolute top-1/4 left-1/2 w-[300px] h-[150px] sm:w-[400px] sm:h-[200px] md:w-[600px] md:h-[300px] lg:w-[800px] lg:h-[400px] bg-gradient-to-r from-blue-600 to-purple-700 rounded-full blur-2xl sm:blur-3xl transform -translate-x-1/2 -translate-y-1/4"></div>
        <div className="absolute bottom-1/3 right-1/4 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] bg-blue-700 rounded-full blur-2xl sm:blur-3xl transform translate-x-1/4"></div>
        <div className="absolute top-1/2 left-1/4 w-[200px] h-[120px] sm:w-[300px] sm:h-[180px] md:w-[400px] md:h-[240px] lg:w-[500px] lg:h-[300px] bg-gradient-to-r from-purple-600 to-blue-500 rounded-full blur-2xl sm:blur-3xl opacity-80"></div>
      </div>
      
      {/* Customer success themed ambient lights */}
      <div className="absolute inset-0 opacity-20 sm:opacity-25 md:opacity-30">
        {/* Success journey streams */}
        <div 
          className="absolute top-1/4 left-0 w-full h-16 sm:h-24 md:h-32 bg-gradient-to-r from-transparent via-blue-600/15 to-purple-700/20 rounded-full blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '0s', 
        ...
        />
        <div 
          className="absolute bottom-1/3 right-0 w-3/4 h-12 sm:h-18 md:h-24 bg-gradient-to-l from-transparent via-purple-700/25 to-blue-600/15 rounded-full blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '3s', 
        ...
        {/* Customer satisfaction glows */}
        <div 
          className="absolute top-1/2 left-1/4 w-40 h-24 sm:w-60 sm:h-36 md:w-80 md:h-48 bg-gradient-to-br from-blue-600/10 to-purple-500/15 rounded-lg sm:rounded-xl md:rounded-2xl blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '1s', 
        ...
        />
        <div 
          className="absolute bottom-1/4 right-1/3 w-48 h-16 sm:w-72 sm:h-24 md:w-96 md:h-32 bg-gradient-to-tl from-purple-500/20 to-blue-600/10 rounded-lg sm:rounded-xl blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '5s', 
        ...
        {/* Small success particle lights */}
        <div 
          className="absolute top-1/3 right-1/4 w-12 h-8 sm:w-18 sm:h-12 md:w-24 md:h-16 bg-gradient-to-r from-blue-600/25 to-purple-500/30 rounded-md sm:rounded-lg blur-xl sm:blur-2xl" 
          style={{ 
            animationDelay: '2s', 
        ...
        />
        <div 
          className="absolute bottom-1/2 left-1/3 w-16 h-10 sm:w-24 sm:h-15 md:w-32 md:h-20 bg-gradient-to-l from-purple-500/25 to-blue-600/20 rounded-md sm:rounded-lg blur-xl sm:blur-2xl" 
          style={{ 
            animationDelay: '6s', 
      ...
      {/* Hero Content - Using Speed to Lead layout */}
      <div className="relative w-full text-center z-20 px-2 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            {/* Onboard and Beyond Headline - H1 - Mobile Optimized */}
            <h1 className="font-light text-white mb-4 sm:mb-6 md:mb-8 leading-tight tracking-tight" style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, sans-serif' }}>
              <span className="lg:hidden">
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-normal bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent tracking-[-0.01em] leading-normal antialiased pb-2">
              ...
              <span className="hidden lg:block">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-4xl xl:text-5xl font-normal bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent tracking-[-0.01em] leading-normal antialiased pb-2">
                    Seamless Onboarding Agent
                  </div>
                </div>
              </span>
            ...
            <div className="mb-6 sm:mb-8 md:mb-10 mt-2 sm:mt-3 md:mt-4 max-w-2xl lg:max-w-none">
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-400 font-normal leading-relaxed" style={{ fontFamily: 'SF Pro Text, -apple-system, BlinkMacSystemFont, sans-serif' }}>
                Met Onboard & Beyond krijgt elke nieuwe klant direct een persoonlijk welkomstpakket en onboardingplan, volledig automatisch en in jouw branding. Alle informatie wordt meteen verwerkt in je CRM en projectomgeving, zodat je zonder vertraging kunt starten.
              </p>
            </div>
            ...
            <div className="flex justify-center lg:justify-start">
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-purple-700 hover:from-blue-700 hover:to-purple-800 text-white px-12 md:px-16 lg:px-20 py-3 md:py-3.5 text-base md:text-lg font-semibold rounded-full transition-all duration-300 group shadow-lg shadow-blue-500/25"
              >
          ...
          >
            {/* Onboard and Beyond Proof Points - Mobile First Grid */}
...
export default OnboardAndBeyondHero;