...
import { ArrowRight, Zap, Users, TrendingUp, Briefcase, Building, Target } from 'lucide-react';

const AgencyGenerateLeadsSection = () => {
  const handlePartnershipClick = () => {
    window.location.href = '/agency/partnership';
  };

  const handleDemoClick = () => {
    window.location.href = '/agency/demo';
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center">
          ...
          >
            ...
            >
              <span>Plan partnership call</span>
...
export default AgencyGenerateLeadsSection;