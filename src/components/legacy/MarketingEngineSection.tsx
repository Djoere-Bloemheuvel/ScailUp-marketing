    ...
    <section className="relative w-full overflow-hidden py-16 lg:py-20">
      <div className="relative w-full" style={{ height: '60vh' }}>
        ...
        <div className="absolute inset-0" style={{ backgroundColor: '#1a1a1a' }}>
          <img 
            src="/marketing-engine-cinematic-workspace.png"
            alt="Marketing Engine Hero"
            className="w-full h-full object-cover"
            fetchPriority="high"
            decoding="async"
            style={{
              filter: 'brightness(1.2) contrast(1.3) saturate(1.2) sharpen(1px)',
        ...
        <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-black/25 to-transparent pointer-events-none z-20"></div>
        <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-black/25 to-transparent pointer-events-none z-20"></div>

        {/* Content Overlay - Right Aligned */}
        <div className="absolute inset-0 flex items-center justify-end z-10">
          <div className="relative max-w-6xl text-right px-6 lg:px-8 mr-0 lg:mr-4 xl:mr-6">
            ...
            <div className="max-w-5xl">
              ...
              <div className="mt-10 lg:mt-12">
                <div className="relative group inline-block">
                  <div className="absolute inset-0 rounded-full blur-xl opacity-25 group-hover:opacity-40 transition-all duration-500 scale-110 bg-gradient-to-r from-pink-400 via-rose-400 to-purple-400"></div>
                  ...
                  <button
                    ...
                    style={{ 
                      background: `
                        linear-gradient(135deg, rgba(244, 114, 182, 0.12) 0%, rgba(251, 113, 133, 0.08) 50%, rgba(168, 85, 247, 0.12) 100%),
                        padding-box,
                        linear-gradient(to right, #f472b6, #fb7185, #a855f7) border-box
                      `,
                      fontFamily: '"Neue Haas Grotesk Display Pro", "SF Pro Display", -apple-system, BlinkMacSystemFont, system-ui, sans-serif',
                      fontWeight: '500',
