...
const WorkMethodologyBackground = () => {
  return (
    <>
      ...
      {/* Enhanced ambient nebula clouds behind steps - more prominent and visible */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
        {/* Step 1 - Discovery & Strategy - Emerald glow */}
        <div 
          className="absolute w-[400px] h-[400px] rounded-full blur-3xl bg-gradient-to-br from-emerald-500/25 to-teal-400/15"
          style={{
            top: '15%',
            left: '5%',
        ...
        <div 
          className="absolute w-[380px] h-[380px] rounded-full blur-3xl bg-gradient-to-br from-yellow-500/30 to-orange-400/20"
          style={{
            top: '10%',
            left: '30%',
        ...
        <div 
          className="absolute w-[420px] h-[420px] rounded-full blur-3xl bg-gradient-to-br from-blue-500/28 to-indigo-400/18"
          style={{
            top: '12%',
            left: '55%',
        ...
        <div 
          className="absolute w-[390px] h-[390px] rounded-full blur-3xl bg-gradient-to-br from-purple-500/26 to-pink-400/16"
          style={{
            top: '8%',
            left: '80%',
        ...
        <div 
          className="absolute w-[300px] h-[300px] rounded-full blur-2xl bg-gradient-to-br from-emerald-400/20 to-blue-400/12"
          style={{
            bottom: '20%',
            left: '15%',
        ...
        <div 
          className="absolute w-[320px] h-[320px] rounded-full blur-2xl bg-gradient-to-br from-purple-400/22 to-indigo-400/14"
          style={{
            bottom: '15%',
            right: '20%',
        ...
        <div 
          className="absolute w-[250px] h-[250px] rounded-full blur-2xl bg-gradient-to-br from-teal-400/18 to-emerald-400/10"
          style={{
            top: '40%',
            left: '40%',
        ...
        <div 
          className="absolute w-[280px] h-[280px] rounded-full blur-2xl bg-gradient-to-br from-indigo-400/20 to-purple-400/12"
          style={{
            top: '50%',
            right: '35%',
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-500/8 rounded-full blur-3xl" />
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-purple-500/8 rounded-full blur-3xl" />
