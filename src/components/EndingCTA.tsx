...
const EndingCTA = () => {
  ...
  return (
    <section className="relative min-h-[120vh] overflow-hidden bg-black flex items-center justify-center py-20">
      ...
      {/* Premium Background Layers - confined to content area with new color scheme */}
      <div className="absolute inset-0 z-6">
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="relative w-full">
            {/* Premium Background Layers - now with orange/amber/red color scheme */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
              {/* Central focal glow - changed to warm amber/orange tones */}
              <div 
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full"
                style={{
                  background: 'radial-gradient(circle, rgba(251, 146, 60, 0.15) 0%, rgba(249, 115, 22, 0.10) 40%, rgba(234, 88, 12, 0.05) 70%, transparent 85%)',
                  filter: 'blur(120px)',
                  animation: 'premium-focal-glow 12s ease-in-out infinite'
                }}
              />
              
              {/* Particle system - updated with warm colors */}
              <div className="absolute inset-0">
                {Array.from({ length: 8 }).map((_, i) => (
                  <div
                    ...
                    style={{
                      background: i % 3 === 0 ? 'rgba(251, 146, 60, 0.8)' : 
                                 i % 3 === 1 ? 'rgba(249, 115, 22, 0.6)' : 
                                 'rgba(239, 68, 68, 0.7)',
                      left: `${15 + (i * 9) % 70}%`,
                      top: `${25 + (i * 11) % 50}%`,
        ...
        <div className="relative">
          ...
          <div className="premium-glass-main-container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20 lg:py-24">
              ...
              {/* Right Visual Element - updated with warm color scheme */}
              <div className="relative flex items-center justify-center order-1 lg:order-2 premium-visual-entrance">
                {/* Premium AI Visualization with warm colors */}
                <div className="relative">
                  {/* Outer quantum field - changed to warm orange/amber */}
                  <div className="absolute inset-0 w-80 h-80 rounded-full premium-quantum-field" />
                  
                  {/* Core visualization container - updated colors */}
                  <div className="relative w-64 h-64 rounded-full premium-core-container flex items-center justify-center">
                    ...
                    {/* Orbiting intelligence nodes - updated with warm gradient colors */}
                    <div className="absolute inset-0">
                      {[0, 1, 2, 3].map(i => (
                        <div 
                          key={`node-${i}`} 
                          ...
                          style={{
                            background: i % 2 === 0 ? 
                              'linear-gradient(45deg, rgba(251, 146, 60, 1), rgba(249, 115, 22, 1))' : 
                              'linear-gradient(45deg, rgba(239, 68, 68, 1), rgba(220, 38, 127, 1))',
                            animation: `premium-orbit ${20 + i * 4}s linear infinite`,
                            transform: `rotate(${i * 90}deg) translateY(-${110 + i * 8}px)`,
                            transformOrigin: '50% 50%',
                            boxShadow: '0 0 15px rgba(251, 146, 60, 0.5), 0 0 30px rgba(249, 115, 22, 0.3)'
                          }} 
                        />
                      ))}
                    </div>
                    
                    {/* Neural network connections - updated gradient */}
                    <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-30">
                      ...
                      <defs>
                        <linearGradient id="neuralGradientWarm" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      {/* Premium Animation Styles - updated color values */}
      <style dangerouslySetInnerHTML={{
        __html: `
          ...
          @keyframes premium-brain-pulse {
            ...
            50% { 
              filter: drop-shadow(0 0 50px rgba(251, 146, 60, 0.6));
          ...
          /* Premium Glass Container - updated background tints */}
          .premium-glass-main-container {
            ...
            box-shadow: 
              ...
              0 6px 12px rgba(249, 115, 22, 0.08),
          ...
          .premium-cta-button {
            ...
            box-shadow: 
              ...
              0 3px 12px rgba(251, 146, 60, 0.2),
          ...
          .premium-cta-button:hover {
            ...
            box-shadow: 
              ...
              0 6px 18px rgba(251, 146, 60, 0.3),
              0 3px 9px rgba(249, 115, 22, 0.2);
          }
          ...
          /* Visual Elements - updated with warm color scheme */}
