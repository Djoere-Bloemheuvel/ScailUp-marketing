...
const ConnectToClientHero = () => {
  ...
  const stats = [
    { value: "3-5x", label: "hogere acceptatie", description: "dan generieke berichten" },
    { value: "100%", label: "autonome uitvoering", description: "van lead tot meeting" },
    { value: "Safe", label: "LinkedIn compliant", description: "binnen alle richtlijnen" },
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-0 overflow-hidden">
      ...
      {/* Connect to Client themed backlights - blue LinkedIn theme */}
      <div className="absolute inset-0 overflow-hidden opacity-50 sm:opacity-60">
        <div className="absolute top-1/4 left-1/2 w-[300px] h-[150px] sm:w-[400px] sm:h-[200px] md:w-[600px] md:h-[300px] lg:w-[800px] lg:h-[400px] bg-gradient-to-r from-blue-300 via-blue-500 to-indigo-700 rounded-full blur-2xl sm:blur-3xl transform -translate-x-1/2 -translate-y-1/4"></div>
        <div className="absolute bottom-1/3 right-1/4 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] bg-blue-500 rounded-full blur-2xl sm:blur-3xl transform translate-x-1/4"></div>
        <div className="absolute top-1/2 left-1/4 w-[200px] h-[120px] sm:w-[300px] sm:h-[180px] md:w-[400px] md:h-[240px] lg:w-[500px] lg:h-[300px] bg-gradient-to-r from-blue-500 to-blue-400 rounded-full blur-2xl sm:blur-3xl opacity-80"></div>
      </div>
      
      {/* Connect to Client themed ambient lights */}
      <div className="absolute inset-0 opacity-20 sm:opacity-25 md:opacity-30">
        {/* LinkedIn connection streams */}
        <div 
          className="absolute top-1/4 left-0 w-full h-16 sm:h-24 md:h-32 bg-gradient-to-r from-transparent via-blue-500/15 to-blue-300/20 rounded-full blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '0s', 
        ...
        />
        <div 
          className="absolute bottom-1/3 right-0 w-3/4 h-12 sm:h-18 md:h-24 bg-gradient-to-l from-transparent via-indigo-600/25 to-blue-500/15 rounded-full blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '3s', 
        ...
        {/* Connection notification glows */}
        <div 
          className="absolute top-1/2 left-1/4 w-40 h-24 sm:w-60 sm:h-36 md:w-80 md:h-48 bg-gradient-to-br from-blue-500/10 to-blue-300/15 rounded-lg sm:rounded-xl md:rounded-2xl blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '1s', 
        ...
        />
        <div 
          className="absolute bottom-1/4 right-1/3 w-48 h-16 sm:w-72 sm:h-24 md:w-96 md:h-32 bg-gradient-to-tl from-blue-300/20 to-blue-500/10 rounded-lg sm:rounded-xl blur-2xl sm:blur-3xl" 
          style={{ 
            animationDelay: '5s', 
        ...
        {/* Small connection particle lights */}
        <div 
          className="absolute top-1/3 right-1/4 w-12 h-8 sm:w-18 sm:h-12 md:w-24 md:h-16 bg-gradient-to-r from-blue-300/25 to-blue-500/30 rounded-md sm:rounded-lg blur-xl sm:blur-2xl" 
          style={{ 
            animationDelay: '2s', 
        ...
        />
        <div 
          className="absolute bottom-1/2 left-1/3 w-16 h-10 sm:w-24 sm:h-15 md:w-32 md:h-20 bg-gradient-to-l from-blue-500/25 to-indigo-600/20 rounded-md sm:rounded-lg blur-xl sm:blur-2xl" 
          style={{ 
            animationDelay: '6s', 
      ...
      <div className="relative w-full text-center z-20 px-2 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex justify-center lg:justify-start">
              <button
                ...
                className="bg-gradient-to-r from-blue-300 via-blue-500 to-indigo-700 hover:from-blue-400 hover:via-blue-600 hover:to-indigo-800 text-white px-12 md:px-16 lg:px-20 py-3 md:py-3.5 text-base md:text-lg font-semibold rounded-full transition-all duration-300 group shadow-lg shadow-blue-500/25"
              >
          ...
          >
            {/* Connect to Client Proof Points - Compact Design */}
...
export default ConnectToClientHero;