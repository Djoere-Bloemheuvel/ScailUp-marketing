            ...
            >
              ...
              <div className="relative z-10 flex-shrink-0">
                ...
                {index < steps.length - 1 && (
                  <div className="absolute top-16 left-8 w-px h-12 bg-gradient-to-b from-white/30 to-transparent transform -translate-x-0.5" />
                )}
              </div>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <div className="flex items-center mb-3">
                        ...
                        <ArrowRight className={`w-4 h-4 text-white/60 transition-all duration-300 ${activeStep === step.id ? 'rotate-90 text-white' : 'group-hover:translate-x-1'}`} />
                      </div>
