...
const Hero = () => {
  ...
  useEffect(() => {
    // Fast initial load - prioritize content rendering
    setIsLoaded(true);
    
    // Delay the glass container loading to optimize initial load speed
    const timer = setTimeout(() => {
      setIsInitialLoadComplete(true);
    }, 800); // Give time for content to render first
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-12 bg-black overflow-hidden">
      ...
      <div className={`absolute inset-0 ${isLoaded ? 'hero-entrance' : ''}`}>
        <CinematicBackground isInitialLoadComplete={isInitialLoadComplete} />
      </div>
      ...
      <div className="relative max-w-5xl mx-auto z-30 text-center px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative">
            ...
            {/* Apple-style Reflection Effect - Only render after initial load */}
      ...
      {/* Premium scroll indicator - Only show after initial load */}
      {isInitialLoadComplete && (
